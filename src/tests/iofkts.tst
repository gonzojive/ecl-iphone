...
(MULTIPLE-VALUE-LIST (PARSE-INTEGER "  123  " :JUNK-ALLOWED T))
(123 #+XCL 7 #+(or CLISP ECLS AKCL ALLEGRO) 5 #-(or XCL CLISP ECLS AKCL ALLEGRO) UNKNOWN)

(MULTIPLE-VALUE-LIST (PARSE-INTEGER "123 t" :JUNK-ALLOWED T))
(123 #+XCL 4 #+(or CLISP ECLS AKCL ALLEGRO) 3 #-(or XCL CLISP ECLS AKCL ALLEGRO) UNKNOWN)

(MULTIPLE-VALUE-LIST (PARSE-INTEGER "  123   t  " :JUNK-ALLOWED T))
(123 #+XCL 8 #+(or CLISP ECLS AKCL ALLEGRO) 5 #-(or XCL CLISP ECLS AKCL ALLEGRO) UNKNOWN)
...
(1 #+XCL 2 #+(or CLISP ECLS AKCL ALLEGRO) 1 #-(or XCL CLISP ECLS AKCL ALLEGRO) UNKNOWN)
...
20) (READ S))
#+XCL CRACKERS #+(or CLISP ECLS AKCL ALLEGRO) ERROR #-(or XCL CLISP ECLS AKCL ALLEGRO) UNKNOWN

J
#+XCL 20 #+(or CLISP ECLS AKCL ALLEGRO) 7 #-(or XCL CLISP ECLS AKCL ALLEGRO) UNKNOWN
...
#-(or XCL CLISP ECLS AKCL) UNKNOWN

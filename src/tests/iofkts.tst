...
(MULTIPLE-VALUE-LIST (PARSE-INTEGER "  123  " :JUNK-ALLOWED T))
(123 #+XCL 7 #+(or CLISP ECL AKCL ALLEGRO) 5 #-(or XCL CLISP ECL AKCL ALLEGRO) UNKNOWN)

(MULTIPLE-VALUE-LIST (PARSE-INTEGER "123 t" :JUNK-ALLOWED T))
(123 #+XCL 4 #+(or CLISP ECL AKCL ALLEGRO) 3 #-(or XCL CLISP ECL AKCL ALLEGRO) UNKNOWN)

(MULTIPLE-VALUE-LIST (PARSE-INTEGER "  123   t  " :JUNK-ALLOWED T))
(123 #+XCL 8 #+(or CLISP ECL AKCL ALLEGRO) 5 #-(or XCL CLISP ECL AKCL ALLEGRO) UNKNOWN)
...
(1 #+XCL 2 #+(or CLISP ECL AKCL ALLEGRO) 1 #-(or XCL CLISP ECL AKCL ALLEGRO) UNKNOWN)
...
#+(or CLISP ALLEGRO) CHARACTER #+ECL BASE-CHAR #-(or CLISP ALLEGRO ECL) STRING-CHAR
...
#-ECL (STRING-CHAR-P (QUOTE A))
#-ECL ERROR

#-ECL (STRING-CHAR-P (QUOTE #\SPACE))
#-ECL T

#-ECL (STRING-CHAR-P (QUOTE #\NEWLINE))
#-ECL T

#-ECL (STRING-CHAR-P (QUOTE #\BACKSPACE))
#-ECL T

#-ECL (STRING-CHAR-P (QUOTE #\a))
#-ECL T

#-ECL (STRING-CHAR-P (QUOTE #\8))
#-ECL T

#-ECL (STRING-CHAR-P (QUOTE #\-))
#-ECL T
...
20) (READ S))
#+XCL CRACKERS #+(or CLISP ECL AKCL ALLEGRO) ERROR #-(or XCL CLISP ECL AKCL ALLEGRO) UNKNOWN

J
#+XCL 20 #+(or CLISP ECL AKCL ALLEGRO) 7 #-(or XCL CLISP ECL AKCL ALLEGRO) UNKNOWN
...
#+(or XCL ECL) "Das ist wieder einmal einer der SUUPERTESTstrings."
#-(or XCL ECL) ERROR
...
(SETQ A (MAKE-ARRAY 10 :ELEMENT-TYPE (QUOTE #-ECL STRING-CHAR #+ECL BASE-CHAR) :FILL-POINTER
0))
""
...
(SETQ A
(MAKE-ARRAY 10 :ELEMENT-TYPE (QUOTE #-ECL STRING-CHAR #+ECL BASE-CHAR) :FILL-POINTER 0 :ADJUSTABLE
T))
""

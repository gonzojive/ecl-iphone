...
(and (find-package "CL") t)
T
(and (find-package "COMMON-LISP") t)
T
(and (find-package "CL-USER") t)
T
(and (find-package "COMMON-LISP-USER") t)
T
(and (find-package "KEYWORD") t)
T

;nicknames
(find "CL" (package-nicknames 'common-lisp) :test #'string=)
"CL"
...
(and (defpackage "TEST2"
       (:nicknames "T2" "TST2")
       (:use test1))
     t)
t

(and (in-package test2) t)
cl:t
...
(lisp:and (lisp:in-package cl-user) lisp:T)
LISP:T

(setf x 1 y 2 z 3)
3

(and (make-package 'editor)(in-package editor) t)
T

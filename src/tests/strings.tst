...
(STRING-TRIM   (QUOTE (A)) "ababa")
#+XCL error #+(or CLISP GCL ECL ALLEGRO) "ababa" #-(or XCL CLISP GCL ECL ALLEGRO) UNKNOWN
...
(STRING-LEFT-TRIM   (QUOTE (A)) "ababa")
#+XCL error #+(or CLISP GCL ECL ALLEGRO) "ababa" #-(or XCL ECL CLISP GCL ALLEGRO) UNKNOWN
...
(STRING-RIGHT-TRIM   (QUOTE (A)) "ababa")
#+XCL error #+(or ECL CLISP GCL ALLEGRO) "ababa" #-(or XCL ECL CLISP GCL ALLEGRO) UNKNOWN

...
{"ARRAY-DIMENSION-LIMIT", CL_ORDINARY, NULL, -1},
...
{"ASSOC-IF", CL_ORDINARY, cl_assoc_if, -1},
{"ASSOC-IF-NOT", CL_ORDINARY, cl_assoc_if_not, -1},
...
{"LOAD-TIME-VALUE", CL_ORDINARY, NULL, -1},
...
{"MEMBER-IF", CL_ORDINARY, cl_member_if, -1},
{"MEMBER-IF-NOT", CL_ORDINARY, cl_member_if_not, -1},
...
{"NSUBST-IF", CL_ORDINARY, cl_nsubst_if, -1},
{"NSUBST-IF-NOT", CL_ORDINARY, cl_nsubst_if_not, -1},
...
{"RASSOC-IF", CL_ORDINARY, cl_rassoc_if, -1},
{"RASSOC-IF-NOT", CL_ORDINARY, cl_rassoc_if_not, -1},
...
{"SUBST-IF", CL_ORDINARY, cl_subst_if, -1},
{"SUBST-IF-NOT", CL_ORDINARY, cl_subst_if_not, -1},
...
{"SI::COMPILED-FUNCTION-SOURCE", SI_ORDINARY, si_compiled_function_source, 1},
...
{"SI::MKDIR", SI_ORDINARY, si_mkdir, 1},
{"SI::OPEN-PIPE", SI_ORDINARY, si_open_pipe, 1},
{"SI::OUTPUT-STREAM-STRING", SI_ORDINARY, si_output_stream_string, 1},
{"SI::PACKAGE-EXTERNAL", SI_ORDINARY, si_package_external, 2},
{"SI::PACKAGE-INTERNAL", SI_ORDINARY, si_package_internal, 2},
{"SI::PACKAGE-LOCK", SI_ORDINARY, si_package_lock, 2},
{"SI::PACKAGE-SIZE", SI_ORDINARY, si_package_size, 1},
...
{"SI::PROCESS-LAMBDA-LIST", SI_ORDINARY, si_process_lambda_list, 1},

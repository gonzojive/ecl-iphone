...
init_number(void)
{
	...
	cl_core.imag_unit =
	    make_complex(make_singlefloat(0.0), make_singlefloat(1.0));
	cl_core.minus_imag_unit =
	    make_complex(make_singlefloat(0.0), make_singlefloat(-1.0));
	cl_core.imag_two =
	    make_complex(make_singlefloat(0.0), make_singlefloat(2.0));

	ECL_SET(@'pi', make_doublefloat(M_PI));

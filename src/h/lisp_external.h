...
extern cl_object clSfile_stream;
extern cl_object clSstring_stream;
extern cl_object clSsynonym_stream;
extern cl_object clStwo_way_stream;
extern cl_object clSbroadcast_stream;
extern cl_object clSconcatenated_stream;
extern cl_object clSecho_stream;
...
extern cl_object siLmkdir _ARGS((int narg, cl_object directory, cl_object mode));

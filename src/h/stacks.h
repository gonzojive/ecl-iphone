...
#define lex_fun_sch(name)	lex_sch(CDR(lex_env),(name),Sfunction)
#define lex_tag_sch(name)	lex_sch(CDR(lex_env),(name),Stag)
#define lex_block_sch(name)	lex_sch(CDR(lex_env),(name),Sblock)
